        ...
        const movieCard = `
            <div class="bg-gray-900 text-white rounded-lg shadow-md overflow-hidden p-4 relative">
                ...
                <button 
                    ...
                    class="absolute bottom-4 right-4 text-xl bg-gray-200 rounded-full p-2 shadow-xl ${
        ...
        const favoriteCard = `
            <div class="bg-gray-900 text-white rounded-lg shadow-md overflow-hidden p-4 relative">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-300"><strong>Watched Date:</strong> ${
                        movie.watchedDate ? movie.watchedDate : "Not set"
                    }</p>
